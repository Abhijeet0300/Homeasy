...
fun RegisterScreen(
    ...
    val  emailVM by registerViewModel.email.collectAsState()
    val passwordVM by registerViewModel.password.collectAsState()
    ...
    Column(
        ...
        RegularButton(
            ...
            onClick = {
                registerViewModel.setEmail(emailAddress.value)
                registerViewModel.setPassword(password.value)
